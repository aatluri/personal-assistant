...
### Interfaces
- Interfaces define the shape of the props a component accepts.
- They provide type safety and better editor support.
...
- A reusable component can inherit all standard HTML attributes by extending the appropriate HTML interface.
...
This allows the component to automatically support attributes like:
- `id`
- `name`
- `type`
- `min`
...
### Spread Operator (`...`)
- The spread operator passes all remaining props to another component or HTML element.
...
React automatically expands all the properties from `inputProps`.
