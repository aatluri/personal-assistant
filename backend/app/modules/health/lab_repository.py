...
def get_current_datetime() -> str:
    """
    Return the current backend date/time in the standard format
    used for Updated_DateTime fields.
    """
...
def create_lab_report(report: LabReport) -> LabReport:
    ...
    # Updated_DateTime is system metadata and is always
    ...
    # Return the saved model including the backend-generated
...
def update_lab_report(
    ...
    for index, record in enumerate(records, start=2):
        ...
        if record["Report_Key"] == report_key:
            ...
            # Generate a new timestamp every time the
            # existing record is updated.
            updated_datetime = get_current_datetime()

            worksheet.update(
                range_name=f"B{index}:I{index}",
                values=[[
                    report.report_date,
                    report.collection_date,
                    report.report_datetime,
            ...
            # Report_Key remains unchanged because it is the
            # unique identifier for this report.
            #
            # Updated_DateTime is returned using the value
...
def create_lab_marker_definition(
    ...
    # Updated_DateTime is generated by the backend
    # whenever a marker definition is created.
    updated_datetime = get_current_datetime()
    ...
    # Return the saved definition including the
...
def update_lab_marker_definition(
    ...
    for index, record in enumerate(records, start=2):
        ...
        if record["Marker_Key"] == marker_key:
            ...
            # Generate a new timestamp whenever the
            # marker definition is updated.
            updated_datetime = get_current_datetime()
...
def create_lab_marker_reference_range(
    ...
    # Updated_DateTime is generated by the backend
    # whenever a reference range is created.
    updated_datetime = get_current_datetime()
...
def create_lab_marker_interpretation(
    ...
    # Updated_DateTime is generated by the backend
    # whenever an interpretation is created.
    updated_datetime = get_current_datetime()
...
def create_lab_result(
    ...
    # Updated_DateTime is generated by the backend
    # whenever a lab result is created.
    updated_datetime = get_current_datetime()
...
def update_lab_result(
    ...
    for index, record in enumerate(records, start=2):
        ...
        if (
            ...
            # Generate a new timestamp whenever
            # the lab result is updated.
            updated_datetime = get_current_datetime()
